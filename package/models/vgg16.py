...
def vgg16(inputs,input_shape=(128,128,3)):
    ...
    VGG16_encoder = tf.keras.models.Model(base_model.input,
                                    base_model_outputs)

    return VGG16_encoder(inputs)
...
def VGG16_Unet(
    ...
    """
        Multiple class semantic segmentation
